...
const ManageVendors = () => {
    ...
    const RenderItem = ({ item }: RenderItemProps) => (
        <View style={{ marginVertical: 10 }}>
            <View style={{
                flexDirection: 'row', justifyContent: 'space-between', borderWidth: 0.7, borderRadius: 2, padding: 15,
            }}>
                <View>
                        ...
                        {selectedItem && (
                            <View style={{ marginHorizontal: 15, gap: 15, backgroundColor: '#fff', justifyContent: "center", alignSelf: "center", width: "90%", padding: 15, borderRadius: 10, elevation: 10 }}>
                                ...
                                <View style={{flexDirection:'row',justifyContent:'space-evenly'}}>
                                    <Pressable style={{borderColor:'red',backgroundColor:'#FF0000',padding:7,}}>
                                        <Text style={{color:'white'}}>
                                            Deactivate
                                        </Text>
                                    </Pressable>
                                    <Pressable style={{borderColor:'black',borderWidth:1,padding:7,backgroundColor:'black',width:70,}} onPress={() => setModalVisible(false)}>
...
//   return (
//     <View>
//       <Text style={{fontFamily:'Courier New, monospace'}}>Test</Text>
//     </View>
//   )
// }
